/* Stage is basically preparing your environment to access data from external source*/
CREATE STAGE my_stage
URL = "s3://snowflake-db-dimensional-modelling/instacart/"
CREDENTIALS = (AWS_KEY_ID = '*************************' AWS_SECRET_KEY = '*****************************');

/*specifing which type of files we working with to snowflake */
...
/*below things are yet to execute */
...
/*From raw table to fact and dim table the process is called transformation */
